...
Description:  Property editor for MidWare component TMWTable
...
{$IFDEF VER140}
  ...
  // Add designide.dcp to Midware package (MwDel60.dpk)
...
const
  LOPropVersion      = 104;
  CopyRight : String = ' TLayoutProperty (c) 1998 F. Piette V1.04 ';
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TLayoutEditForm.LayoutStringGridKeyPress(Sender: TObject;
  var Key: Char);
var
    Rect    : TRect;
    FldType : TFieldType;
