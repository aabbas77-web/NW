...
// (DO NOT EDIT: machine generated header) 'MSACM.pas' rev: 5.00
...
typedef BOOL __stdcall (*ACMFORMATTAGENUMCBA)(unsigned hadid, const TACMFORMATTAGDETAILSA &paftd, unsigned 
	dwInstance, unsigned fdwSupport);

typedef BOOL __stdcall (*ACMFORMATTAGENUMCBW)(unsigned hadid, const TACMFORMATTAGDETAILSW &paftd, unsigned 
	dwInstance, unsigned fdwSupport);

typedef BOOL __stdcall (*ACMFORMATTAGENUMCB)(unsigned hadid, const TACMFORMATTAGDETAILSA &paftd, unsigned 
	dwInstance, unsigned fdwSupport);
...
typedef BOOL __stdcall (*ACMFORMATENUMCBA)(unsigned hadid, const TACMFORMATDETAILSA &pafd, unsigned 
	dwInstance, unsigned fdwSupport);

typedef BOOL __stdcall (*ACMFORMATENUMCBW)(unsigned hadid, const TACMFORMATDETAILSW &pafd, unsigned 
	dwInstance, unsigned fdwSupport);

typedef BOOL __stdcall (*ACMFORMATENUMCB)(unsigned hadid, const TACMFORMATDETAILSA &pafd, unsigned dwInstance
	, unsigned fdwSupport);
...
typedef BOOL __stdcall (*ACMFILTERTAGENUMCBA)(unsigned hadid, const TACMFILTERTAGDETAILSA &paftd, unsigned 
	dwInstance, unsigned fdwSupport);

typedef BOOL __stdcall (*ACMFILTERTAGENUMCBW)(unsigned hadid, const TACMFILTERTAGDETAILSW &paftd, unsigned 
	dwInstance, unsigned fdwSupport);

typedef BOOL __stdcall (*ACMFILTERTAGENUMCB)(unsigned hadid, const TACMFILTERTAGDETAILSA &paftd, unsigned 
	dwInstance, unsigned fdwSupport);
...
typedef BOOL __stdcall (*ACMFILTERENUMCBA)(unsigned hadid, const TACMFILTERDETAILSA &pafd, unsigned 
	dwInstance, unsigned fdwSupport);

typedef BOOL __stdcall (*ACMFILTERENUMCBW)(unsigned hadid, const TACMFILTERDETAILSW &pafd, unsigned 
	dwInstance, unsigned fdwSupport);

typedef BOOL __stdcall (*ACMFILTERENUMCB)(unsigned hadid, const TACMFILTERDETAILSA &pafd, unsigned dwInstance
	, unsigned fdwSupport);
...
extern "C" unsigned __stdcall acmDriverEnum(ACMDRIVERENUMCB fnCallback, unsigned dwInstance, unsigned 
	fdwEnum);
extern "C" unsigned __stdcall acmDriverID(unsigned hao, unsigned &phadid, unsigned fdwDriverID);
extern "C" unsigned __stdcall acmDriverAddA(unsigned &phadid, unsigned hinstModule, int lParam, unsigned 
	dwPriority, unsigned fdwAdd);
extern "C" unsigned __stdcall acmDriverAddW(unsigned &phadid, unsigned hinstModule, int lParam, unsigned 
	dwPriority, unsigned fdwAdd);
extern "C" unsigned __stdcall acmDriverAdd(unsigned &phadid, unsigned hinstModule, int lParam, unsigned 
	dwPriority, unsigned fdwAdd);
...
extern "C" unsigned __stdcall acmFormatTagDetailsA(unsigned had, TACMFORMATTAGDETAILSA &paftd, unsigned 
	fdwDetails);
extern "C" unsigned __stdcall acmFormatTagDetailsW(unsigned had, TACMFORMATTAGDETAILSW &paftd, unsigned 
	fdwDetails);
extern "C" unsigned __stdcall acmFormatTagDetails(unsigned had, TACMFORMATTAGDETAILSA &paftd, unsigned 
	fdwDetails);
extern "C" unsigned __stdcall acmFormatTagEnumA(unsigned had, TACMFORMATTAGDETAILSA &paftd, ACMFORMATTAGENUMCBA 
	fnCallback, unsigned dwInstance, unsigned fdwEnum);
extern "C" unsigned __stdcall acmFormatTagEnumW(unsigned had, TACMFORMATTAGDETAILSW &paftd, ACMFORMATTAGENUMCBW 
	fnCallback, unsigned dwInstance, unsigned fdwEnum);
extern "C" unsigned __stdcall acmFormatTagEnum(unsigned had, TACMFORMATTAGDETAILSA &paftd, ACMFORMATTAGENUMCBA 
	fnCallback, unsigned dwInstance, unsigned fdwEnum);
...
extern "C" unsigned __stdcall acmFormatEnumA(unsigned had, TACMFORMATDETAILSA &pafd, ACMFORMATENUMCBA 
	fnCallback, unsigned dwInstance, unsigned fdwEnum);
extern "C" unsigned __stdcall acmFormatEnumW(unsigned had, TACMFORMATDETAILSW &pafd, ACMFORMATENUMCBW 
	fnCallback, unsigned dwInstance, unsigned fdwEnum);
extern "C" unsigned __stdcall acmFormatEnum(unsigned had, TACMFORMATDETAILSA &pafd, ACMFORMATENUMCBA 
	fnCallback, unsigned dwInstance, unsigned fdwEnum);
extern "C" unsigned __stdcall acmFormatSuggest(unsigned had, const tWAVEFORMATEX &pwfxSrc, tWAVEFORMATEX 
	&pwfxDst, unsigned cbwfxDst, unsigned fdwSuggest);
...
extern "C" unsigned __stdcall acmFilterTagDetailsA(unsigned had, TACMFILTERTAGDETAILSA &paftd, unsigned 
	fdwDetails);
extern "C" unsigned __stdcall acmFilterTagDetailsW(unsigned had, TACMFILTERTAGDETAILSW &paftd, unsigned 
	fdwDetails);
extern "C" unsigned __stdcall acmFilterTagDetails(unsigned had, TACMFILTERTAGDETAILSA &paftd, unsigned 
	fdwDetails);
extern "C" unsigned __stdcall acmFilterTagEnumA(unsigned had, TACMFILTERTAGDETAILSA &paftd, ACMFILTERTAGENUMCBA 
	fnCallback, unsigned dwInstance, unsigned fdwEnum);
extern "C" unsigned __stdcall acmFilterTagEnumW(unsigned had, TACMFILTERTAGDETAILSW &paftd, ACMFILTERTAGENUMCBW 
	fnCallback, unsigned dwInstance, unsigned fdwEnum);
extern "C" unsigned __stdcall acmFilterTagEnum(unsigned had, TACMFILTERTAGDETAILSA &paftd, ACMFILTERTAGENUMCBA 
	fnCallback, unsigned dwInstance, unsigned fdwEnum);
...
extern "C" unsigned __stdcall acmFilterEnumA(unsigned had, TACMFILTERDETAILSA &pafd, ACMFILTERENUMCBA 
	fnCallback, unsigned dwInstance, unsigned fdwEnum);
extern "C" unsigned __stdcall acmFilterEnumW(unsigned had, TACMFILTERDETAILSW &pafd, ACMFILTERENUMCBW 
	fnCallback, unsigned dwInstance, unsigned fdwEnum);
extern "C" unsigned __stdcall acmFilterEnum(unsigned had, TACMFILTERDETAILSA &pafd, ACMFILTERENUMCBA 
	fnCallback, unsigned dwInstance, unsigned fdwEnum);
...
extern "C" unsigned __stdcall acmStreamOpen(PHACMSTREAM phas, unsigned had, const tWAVEFORMATEX &pwfxSrc
	, const tWAVEFORMATEX &pwfxdst, PWAVEFILTER pwfltr, unsigned dwCallback, unsigned dwInstance, unsigned 
	fdwOpen);
extern "C" unsigned __stdcall acmStreamClose(unsigned has, unsigned fdwClose);
extern "C" unsigned __stdcall acmStreamSize(unsigned has, unsigned cbInput, unsigned &pdwOutputByte, 
	unsigned fdwSize);
...
extern "C" unsigned __stdcall acmStreamPrepareHeader(unsigned has, TACMSTREAMHEADER &pash, unsigned 
	fdwPrepare);
extern "C" unsigned __stdcall acmStreamUnprepareHeader(unsigned has, TACMSTREAMHEADER &pash, unsigned 
	fdwUnprepare);

#if defined(UNICODE)
#pragma option push -w-inl
inline unsigned __stdcall acmDriverAdd(unsigned &phadid, unsigned hinstModule, int lParam, unsigned 
	dwPriority, unsigned fdwAdd)
{
...
#if defined(UNICODE)
#pragma option push -w-inl
inline unsigned __stdcall acmFormatTagEnum(unsigned had, TACMFORMATTAGDETAILSA &paftd, ACMFORMATTAGENUMCBA 
	fnCallback, unsigned dwInstance, unsigned fdwEnum)
{
...
#if defined(UNICODE)
#pragma option push -w-inl
inline unsigned __stdcall acmFormatEnum(unsigned had, TACMFORMATDETAILSA &pafd, ACMFORMATENUMCBA fnCallback
	, unsigned dwInstance, unsigned fdwEnum)
{
...
#if defined(UNICODE)
#pragma option push -w-inl
inline unsigned __stdcall acmFilterTagEnum(unsigned had, TACMFILTERTAGDETAILSA &paftd, ACMFILTERTAGENUMCBA 
	fnCallback, unsigned dwInstance, unsigned fdwEnum)
{
...
#if defined(UNICODE)
#pragma option push -w-inl
inline unsigned __stdcall acmFilterEnum(unsigned had, TACMFILTERDETAILSA &pafd, ACMFILTERENUMCBA fnCallback
	, unsigned dwInstance, unsigned fdwEnum)
{
